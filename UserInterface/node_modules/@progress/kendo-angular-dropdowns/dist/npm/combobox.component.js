...
(function (InternalState) {
    ...
    InternalState[InternalState["UseNone"] = 32] = "UseNone";
    InternalState[InternalState["UseEmpty"] = 64] = "UseEmpty";
...
var ComboBoxComponent = (function () {
    ...
    ComboBoxComponent.prototype.resolveState = function (value) {
        ...
        if (this._filtering) {
            ...
            state = this.data.length ? InternalState.UseExisting : (this.allowCustom ? InternalState.UseCustom : InternalState.UseNone);
        }
    ...
    ComboBoxComponent.prototype.emitChange = function () {
        ...
        this.selectionSubject.next(this.data.findIndex(function (element) {
            return util_1.getter(element, _this.valueField) === util_1.getter(_this.value, _this.valueField);
        }));
