...
import { addMonths, addYears, durationInYears, firstMonthOfYear, lastMonthOfYear } from '@progress/kendo-date-math';
...
var YearViewService = (function () {
    ...
    YearViewService.prototype.data = function (options) {
        ...
        return range(0, ROWS_LENGTH).map(function (rowOffset) {
            ...
            return cells.map(function (cellOffset) {
                var cellDate = addMonths(baseDate, cellOffset);
                ...
                return {
                    ...
                    isSelected: isActiveView && _this.isEqual(cellDate, selectedDate),
                    isWeekend: false,
    ...
    YearViewService.prototype.isInRange = function (candidate, min, max) {
        var month = candidate.getMonth();
        var year = candidate.getFullYear();
        var aboveMin = !min || (min.getFullYear() <= year && min.getMonth() <= month);
        var belowMax = !max || (year <= max.getFullYear() && month <= max.getMonth());
