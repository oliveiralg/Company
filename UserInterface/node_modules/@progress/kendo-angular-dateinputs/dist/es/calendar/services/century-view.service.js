...
import { addDecades, addCenturies, durationInCenturies, firstYearOfDecade, firstDecadeOfCentury, lastDecadeOfCentury } from '@progress/kendo-date-math';
 ...
 * @hidden
 */
var CenturyViewService = (function () {
    ...
    CenturyViewService.prototype.data = function (options) {
        ...
        return range(0, ROWS_LENGTH).map(function (rowOffset) {
            ...
            return cells.map(function (cellOffset) {
                var cellDate = addDecades(baseDate, cellOffset);
