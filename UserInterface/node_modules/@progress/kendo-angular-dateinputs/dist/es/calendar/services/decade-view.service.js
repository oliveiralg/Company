...
import { addDecades, addYears, durationInDecades, firstYearOfDecade, lastYearOfDecade } from '@progress/kendo-date-math';
 ...
 * @hidden
 */
var DecadeViewService = (function () {
    ...
    DecadeViewService.prototype.data = function (options) {
        ...
        return range(0, ROWS_LENGTH).map(function (rowOffset) {
            ...
            return cells.map(function (cellOffset) {
                var cellDate = addYears(baseDate, cellOffset);
